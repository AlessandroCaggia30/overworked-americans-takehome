...
\paragraph{Methodological note:} Each of Q4 and Q5 admits a much deeper treatment than we provide, full GE, dynamic bargaining, sectoral migration, heterogeneous firms. We deliberately treat both shallowly because the prompt's substantive question is comparative (Q7: ``derive conditions under which the European system is welfare-enhancing''), and a comparative answer requires coverage of the institutional menu, not depth in any one channel. Q4 and Q5 each show that their respective channel can absorb the residual the simple tax-elasticity mechanism leaves unexplained; Q7 is where these channels are confronted with the US--EU mapping and the welfare verdict is rendered.
