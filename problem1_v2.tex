...
In the firm-power baseline the firm chooses $h$ to maximise its own surplus subject to (i) the regulatory cap $h\le\bar h$ and (ii) the worker's individual-rationality (IR) constraint $V_w(h)\ge V_w^{0}$, with the wage chosen so that IR binds. The Lagrangian is
\[
