% Taxable Income in France for year 1999

function[gross_taxable_income]=fr_taxableinc_1999(wage,ssc_all,workall_min,workall_max,workall_r,basicall_r,csg_ded_r)
