...
%Tax credits
if gross_taxable_income<=red_seuil_1*(1+married)+red_seuil_dp*children
    tax_credit=adj_tax*red_taux;
elseif gross_taxable_income<=red_seuil_2*(1+married)+red_seuil_dp*children
    tax_credit=adj_tax*((gross_taxable_income*red_taux/(red_seuil_1*(1+married)+red_seuil_dp*children-(red_seuil_2*(1+married)+red_seuil_dp*children)))+(red_taux*(red_seuil_2*(1+married)+red_seuil_dp*children))/(red_seuil_2*(1+married)+red_seuil_dp*children-(red_seuil_1*(1+married)+red_seuil_dp*children)));
else
    tax_credit=0;
end


incometax=round(inc_tax+cs_noded_principal+cs_noded_spouse+csg_all_principal+csg_all_spouse-tax_credit);
