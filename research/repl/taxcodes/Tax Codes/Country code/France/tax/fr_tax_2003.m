...
if married==0
    ...
    if children>0
        ppe_cr=ppe_cr + 2*ppe_ch1 +(children-1)*ppe_ch1;
    end
end
...
f_inctax=round(inc_tax+cs_noded+csg_ded-ppe_cr-credit);
