...
function[socsec]=fr_socsec_1993(wage_principal,wage_spouse,pension_r,penex_r,penwidow_r,ssc_ceil,sick_r,unemp_r1,unemp_r2)
...
% pension_empr=pens_empr1*min(wage_principal,ssc_ceil)+(pens_empr2+sick_empr+accid_empr+others_empr1)*wage_principal+penex_empr*min(wage_principal,3*ssc_ceil)+pens_empr1*min(wage_spouse,ssc_ceil)+(pens_empr2+sick_empr+accid_empr+penex_empr+others_empr1)*wage_spouse+penex_empr*min(wage_spouse,3*ssc_ceil);
% 
% % Family
% if wage_principal<1.1*smic
%     family_empr_principal=0;
% elseif wage_principal<1.2*smic
%       family_empr_principal=fam_empr*wage_principal*0.5;
% else
%     family_empr_principal=fam_empr*wage_principal;
% end
% 
% if wage_spouse<1.1*smic
