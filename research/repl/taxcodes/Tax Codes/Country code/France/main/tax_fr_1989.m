% Taxation in France in year 1989

function[inctax,socsec,benefit,netincome]=tax_fr_1989(wage_principal,wage_spouse,married,children)
...
[socsec] =fr_socsec_1989(wage_principal,wage_spouse,pension_r,penex_r,penwidow_r,ssc_ceil,sick_r,unemp_r1,unemp_r2);
	
%********************************** 2)  TAXABLE INCOME CALCULATION   *********************************************************************************************
 
[gross_taxable_income]=fr_taxableinc_1989((wage_principal+wage_spouse),socsec,workall_min,workall_r,basicall_r);
