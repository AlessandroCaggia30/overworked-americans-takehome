%Taxation in France in year 2012

function[inctax,socsec,benefit,netincome,ssc_empr]=tax_fr_2012(wage_principal,wage_spouse,married,children)
...
[socsec,ssc_empr] =fr_socsec_2012(wage_principal,wage_spouse,pension_r,penex_r,penex_r2,penwidow_r,ssc_ceil,sick_r,unemp_r1,pens_empr1,pens_empr2,sick_empr,unemp_empr,accid_empr,smic,fam_empr,penex_empr,penex2_empr,others_empr1,others_empr2,ssc_empr_redr2,ssc_empr_red_max,ssc_empr_smic_ref,minrevtp,csa);
