...
[inctax,local_tax]=it_tax_2007(taxable_income_p,taxable_income_s,married,children,taxbracket1,taxbracket2,taxbracket3,taxbracket4,taxbracket5,tax_r1,tax_r2,tax_r3,tax_r4,tax_r5,reg_rt,sp_crd_lim,emp_cr_bracket1,emp_cr_bracket2,emp_cr_bracket3,emp_cr_bracket4,emp_cr_bracket5,emp_cr_bracket6,emp_cr_bracket7,emp_cr_bracket8,emp_cr_bracket9,emp_cr_bracket10,emp_cr1,emp_cr2,emp_cr3,emp_cr4,emp_cr5,emp_cr6,emp_cr7,emp_cr8,emp_cr9,emp_cr10,spouse_cr_bracket1,spouse_cr_bracket2,spouse_cr_bracket3,spouse_cr_bracket4,spouse_cr_bracket5,spouse_cr_bracket6,spouse_cr_bracket7,spouse_cr_bracket8,spouse_cr_bracket9,spouse_cr_bracket10,spouse_cr1,spouse_cr2,spouse_cr3,spouse_cr4,spouse_cr5,spouse_cr6,spouse_cr7,spouse_cr8,spouse_cr9,spouse_cr10);
...
if children==0 && married==1 
    transfer=((wage<trans_sch_m_noch_thresh2)*trans_sch_m1_noch+(wage>trans_sch_m_noch_thresh2 && wage<=trans_sch_m_noch_thresh3)*trans_sch_m2_noch+(wage>trans_sch_m_noch_thresh3 && wage<=trans_sch_m_noch_thresh4)*trans_sch_m3_noch+(wage>trans_sch_m_noch_thresh4 && wage<=trans_sch_m_noch_thresh5)*trans_sch_m4_noch+(wage>trans_sch_m_noch_thresh5)*trans_sch_m5_noch)+bonus_inc1_1*(wage<bonus_thresh1)+bonus_inc2_1*(wage>=bonus_thresh1);
elseif children==1 && married==0
    transfer=(trans_sch_m_c1-(min(max(0,wage-trans_sch_m_thresh2),(trans_sch_m_thresh4-trans_sch_m_thresh2))*trans_sch_m2_3_c1_red+min(max(0,wage-trans_sch_m_thresh4),(trans_sch_m_thresh9-trans_sch_m_thresh4)) *trans_sch_m4_8_c1_red + min(max(0,wage-trans_sch_m_thresh9),(trans_sch_m_thresh11-trans_sch_m_thresh9))*trans_sch_m9_11_c1_red))+bonus_inc1_1*(wage<bonus_thresh1)+bonus_inc2_1*(wage>=bonus_thresh1);
elseif children==1 && married==1
    transfer=(trans_sch_m_c1-(min(max(0,wage-trans_sch_m_thresh2),(trans_sch_m_thresh4-trans_sch_m_thresh2))*trans_sch_m2_3_c1_red+min(max(0,wage-trans_sch_m_thresh4),(trans_sch_m_thresh9-trans_sch_m_thresh4)) *trans_sch_m4_8_c1_red + min(max(0,wage-trans_sch_m_thresh9),(trans_sch_m_thresh11-trans_sch_m_thresh9))*trans_sch_m9_11_c1_red))+bonus_inc1_2*(wage<bonus_thresh1)+bonus_inc2_2*(wage>=bonus_thresh1);
elseif children==2 && married==0
    transfer=(trans_sch_m_c2-(min(max(0,wage-trans_sch_m_thresh2),(trans_sch_m_thresh5-trans_sch_m_thresh2))*trans_sch_m2_4_c2_red+min(max(0,wage-trans_sch_m_thresh5),(trans_sch_m_thresh9-trans_sch_m_thresh5)) *trans_sch_m5_8_c2_red + min(max(0,wage-trans_sch_m_thresh9),(trans_sch_m_thresh11-trans_sch_m_thresh9))*trans_sch_m9_11_c2_red))+bonus_inc1_2*(wage<bonus_thresh1)+bonus_inc2_2*(wage>=bonus_thresh1);
elseif children==2 && married==1
    transfer=(trans_sch_m_c2-(min(max(0,wage-trans_sch_m_thresh2),(trans_sch_m_thresh5-trans_sch_m_thresh2))*trans_sch_m2_4_c2_red+min(max(0,wage-trans_sch_m_thresh5),(trans_sch_m_thresh9-trans_sch_m_thresh5)) *trans_sch_m5_8_c2_red + min(max(0,wage-trans_sch_m_thresh9),(trans_sch_m_thresh11-trans_sch_m_thresh9))*trans_sch_m9_11_c2_red))+bonus_inc1_3*(wage<bonus_thresh1)+bonus_inc2_3*(wage>=bonus_thresh1 && wage<bonus_thresh2)+bonus_inc3_3*(wage>=bonus_thresh2);
else
    transfer=0;
end
