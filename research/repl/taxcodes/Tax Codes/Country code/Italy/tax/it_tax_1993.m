...
function [inctax_p, inctax_s] = it_tax_1993(married, children,taxable_income_p,taxable_income_s,taxbracket1,taxbracket2,taxbracket3,taxbracket4,taxbracket5,taxbracket6,tax_r1,tax_r2,tax_r3,tax_r4,tax_r5,tax_r6,tax_r7,sp_cred_1,sp_crd_lim,ch1_credit,furth_cred_thresh1,furth_cred_thresh2,furth_cred_thresh3,furth_cred_thresh4,furth_cred1,furth_cred2,furth_cred3)
...
elseif taxable_income_p>furth_cred_thresh2 &&taxable_income_p<=furth_cred_thresh3
    basic_cr_p=(taxable_income_p-furth_cred_thresh2)*((furth_cred2-furth_cred1)/(furth_cred_thresh3-furth_cred_thresh2))+furth_cred1;
elseif taxable_income_p>furth_cred_thresh3 &&taxable_income_p<=furth_cred_thresh4
    basic_cr_p=(taxable_income_p-furth_cred_thresh3)*((furth_cred3-furth_cred2)/(furth_cred_thresh4-furth_cred_thresh3))+furth_cred2;
elseif taxable_income_p>furth_cred_thresh4
    basic_cr_p=furth_cred3;
else
    basic_cr_p=0;
end
...
elseif taxable_income_s>furth_cred_thresh2 &&taxable_income_s<=furth_cred_thresh3
    basic_cr_s=(taxable_income_s-furth_cred_thresh2)*((furth_cred2-furth_cred1)/(furth_cred_thresh3-furth_cred_thresh2))+furth_cred1;
elseif taxable_income_s>furth_cred_thresh3 &&taxable_income_s<=furth_cred_thresh4
    basic_cr_s=(taxable_income_s-furth_cred_thresh3)*((furth_cred3-furth_cred2)/(furth_cred_thresh4-furth_cred_thresh3))+furth_cred2;
elseif taxable_income_s>furth_cred_thresh4
    basic_cr_s=furth_cred3;
else
    basic_cr_s=0;
end  
