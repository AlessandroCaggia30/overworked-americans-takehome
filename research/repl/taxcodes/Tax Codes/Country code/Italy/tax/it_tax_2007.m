...
elseif taxable_inc_p>8000 && taxable_inc_p<=15000
    emp_cr_p=min(inctax_p_gr,emp_cr_max_p+502*(15000-taxable_inc_p)/7000);
elseif taxable_inc_p>15000 && taxable_inc_p<=55000
    emp_cr_p=min(inctax_p_gr,emp_cr_max_p*(55000-taxable_inc_p)/40000);
end

if taxable_inc_s<=8000 || taxable_inc_s>55000
    emp_cr_s=min(inctax_s_gr, emp_cr_max_s);
elseif taxable_inc_s>8000 && taxable_inc_s<=15000
    emp_cr_s=min(inctax_s_gr,emp_cr_max_s+502*(15000-taxable_inc_s)/7000);
elseif taxable_inc_s>15000 && taxable_inc_s<=55000
    emp_cr_s=min(inctax_s_gr,emp_cr_max_s*(55000-taxable_inc_s)/40000);
end
...
if children==0
    ...
    child_crfull_s=(spouse_cr==0)*married*(800*(95000-taxable_inc_s)/95000+(children-1)*800*(110000-taxable_inc_s)/110000);
end
...
if children==0
    ...
    if married>0
        child_cr_p=(800*(95000-taxable_inc_p)/95000+(children-1)*800*(110000-taxable_inc_p)/110000)*(1-child_crpct_s);
    else
        child_cr_p=max(800*(95000-taxable_inc_p)/95000,(taxable_inc_p>80000)*0+(taxable_inc_p<15000)*(800-110*taxable_inc_p/15000)+(taxable_inc_p<=80000 &&taxable_inc_p>40000)*(690* (80000-taxable_inc_p)/40000)+(taxable_inc_p<=40000 &&taxable_inc_p>15000)*((taxable_inc_p<spouse_cr_bracket2)*spouse_cr1+(taxable_inc_p>=spouse_cr_bracket2&& taxable_inc_p<spouse_cr_bracket3)*spouse_cr2+(taxable_inc_p>=spouse_cr_bracket3&& taxable_inc_p<spouse_cr_bracket4)*spouse_cr3+(taxable_inc_p>=spouse_cr_bracket4&& taxable_inc_p<spouse_cr_bracket5)*spouse_cr4+(taxable_inc_p>=spouse_cr_bracket5&& taxable_inc_p<spouse_cr_bracket6)*spouse_cr5+(taxable_inc_p>=spouse_cr_bracket6&& taxable_inc_p<spouse_cr_bracket7)*spouse_cr6+(taxable_inc_p>=spouse_cr_bracket7&& taxable_inc_p<spouse_cr_bracket8)*spouse_cr7+(taxable_inc_p>=spouse_cr_bracket8&& taxable_inc_p<spouse_cr_bracket9)*spouse_cr8+(taxable_inc_p>=spouse_cr_bracket9&& taxable_inc_p<spouse_cr_bracket10)*spouse_cr9+(taxable_inc_p>=spouse_cr_bracket10)*spouse_cr10))+((children-1)*800*(110000-taxable_inc_p)/110000);
    end
end
...
inctax_p=inctax_p_gr-tax_cr_p;
inctax_s=inctax_s_gr-tax_cr_s;
