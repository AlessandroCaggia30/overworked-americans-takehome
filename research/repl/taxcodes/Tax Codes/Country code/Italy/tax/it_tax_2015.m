...
if taxable_inc_p>=15000
    local_tax_p=(taxable_inc_p)*reg_rt;
elseif taxable_inc_p<15000
    local_tax_p=(taxable_inc_p)*reg_rt_2;
end

if taxable_inc_s>=15000
    local_tax_s=(taxable_inc_s)*reg_rt;
elseif taxable_inc_s<15000
    local_tax_s=(taxable_inc_s)*reg_rt_2;
end
