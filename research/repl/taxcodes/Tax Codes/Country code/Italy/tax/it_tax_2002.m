...
if children==0
    child_crfull_s=0;
elseif children==1
    child_crfull_s=(spouse_cr==0)*married*((taxable_income_s>=child_cred_m_thresh1 && taxable_income_s<child_cred_m_thresh2)*child_cred_m_ch1_1+(taxable_income_s>=child_cred_m_thresh2 && taxable_income_s<child_cred_m_thresh3)*child_cred_m_ch1_2+(taxable_income_s>=child_cred_m_thresh3 && taxable_income_s<child_cred_m_thresh4)*child_cred_m_ch1_3+(taxable_income_s>=child_cred_m_thresh4 && taxable_income_s<child_cred_m_thresh5)*child_cred_m_ch1_4+(taxable_income_s>=child_cred_m_thresh5)*child_cred_m_ch1_5);
elseif children==2
    child_crfull_s=(spouse_cr==0)*married*((taxable_income_s>=child_cred_m_thresh1 && taxable_income_s<child_cred_m_thresh2)*child_cred_m_ch2_1+(taxable_income_s>=child_cred_m_thresh2 && taxable_income_s<child_cred_m_thresh3)*child_cred_m_ch2_2+(taxable_income_s>=child_cred_m_thresh3 && taxable_income_s<child_cred_m_thresh4)*child_cred_m_ch2_3+(taxable_income_s>=child_cred_m_thresh4 && taxable_income_s<child_cred_m_thresh5)*child_cred_m_ch2_4+(taxable_income_s>=child_cred_m_thresh5)*child_cred_m_ch2_5);
elseif children==3
    child_crfull_s=(spouse_cr==0)*married*((taxable_income_s>=child_cred_m_thresh1 && taxable_income_s<child_cred_m_thresh2)*child_cred_m_ch3_1+(taxable_income_s>=child_cred_m_thresh2 && taxable_income_s<child_cred_m_thresh3)*child_cred_m_ch3_2+(taxable_income_s>=child_cred_m_thresh3 && taxable_income_s<child_cred_m_thresh4)*child_cred_m_ch3_3+(taxable_income_s>=child_cred_m_thresh4 && taxable_income_s<child_cred_m_thresh5)*child_cred_m_ch3_4+(taxable_income_s>=child_cred_m_thresh5)*child_cred_m_ch3_5);
elseif children==4
    child_crfull_s=(spouse_cr==0)*married*((taxable_income_s>=child_cred_m_thresh1 && taxable_income_s<child_cred_m_thresh2)*child_cred_m_ch4_1+(taxable_income_s>=child_cred_m_thresh2 && taxable_income_s<child_cred_m_thresh3)*child_cred_m_ch4_2+(taxable_income_s>=child_cred_m_thresh3 && taxable_income_s<child_cred_m_thresh4)*child_cred_m_ch4_3+(taxable_income_s>=child_cred_m_thresh4 && taxable_income_s<child_cred_m_thresh5)*child_cred_m_ch4_4+(taxable_income_s>=child_cred_m_thresh5)*child_cred_m_ch4_5);
end
...
if married==1
    if children==0
        child_cr_p=0;
    elseif children==1
        child_cr_p=(1-child_crpct_s)*((taxable_income_p>=child_cred_m_thresh1 && taxable_income_p<child_cred_m_thresh2)*child_cred_m_ch1_1+(taxable_income_p>=child_cred_m_thresh2 && taxable_income_p<child_cred_m_thresh3)*child_cred_m_ch1_2+(taxable_income_p>=child_cred_m_thresh3 && taxable_income_p<child_cred_m_thresh4)*child_cred_m_ch1_3+(taxable_income_p>=child_cred_m_thresh4 && taxable_income_p<child_cred_m_thresh5)*child_cred_m_ch1_4+(taxable_income_p>=child_cred_m_thresh5)*child_cred_m_ch1_5);
    elseif children==2
        child_cr_p=(1-child_crpct_s)*((taxable_income_p>=child_cred_m_thresh1 && taxable_income_p<child_cred_m_thresh2)*child_cred_m_ch2_1+(taxable_income_p>=child_cred_m_thresh2 && taxable_income_p<child_cred_m_thresh3)*child_cred_m_ch2_2+(taxable_income_p>=child_cred_m_thresh3 && taxable_income_p<child_cred_m_thresh4)*child_cred_m_ch2_3+(taxable_income_p>=child_cred_m_thresh4 && taxable_income_p<child_cred_m_thresh5)*child_cred_m_ch2_4+(taxable_income_p>=child_cred_m_thresh5)*child_cred_m_ch2_5);
    elseif children==3
        child_cr_p=(1-child_crpct_s)*((taxable_income_p>=child_cred_m_thresh1 && taxable_income_p<child_cred_m_thresh2)*child_cred_m_ch3_1+(taxable_income_p>=child_cred_m_thresh2 && taxable_income_p<child_cred_m_thresh3)*child_cred_m_ch3_2+(taxable_income_p>=child_cred_m_thresh3 && taxable_income_p<child_cred_m_thresh4)*child_cred_m_ch3_3+(taxable_income_p>=child_cred_m_thresh4 && taxable_income_p<child_cred_m_thresh5)*child_cred_m_ch3_4+(taxable_income_p>=child_cred_m_thresh5)*child_cred_m_ch3_5);
    elseif children==4
        child_cr_p=(1-child_crpct_s)*((taxable_income_p>=child_cred_m_thresh1 && taxable_income_p<child_cred_m_thresh2)*child_cred_m_ch4_1+(taxable_income_p>=child_cred_m_thresh2 && taxable_income_p<child_cred_m_thresh3)*child_cred_m_ch4_2+(taxable_income_p>=child_cred_m_thresh3 && taxable_income_p<child_cred_m_thresh4)*child_cred_m_ch4_3+(taxable_income_p>=child_cred_m_thresh4 && taxable_income_p<child_cred_m_thresh5)*child_cred_m_ch4_4+(taxable_income_p>=child_cred_m_thresh5)*child_cred_m_ch4_5);
    end
else
    if children==0
        child_cr_p=0;
    elseif children==1
        child_cr_p=((taxable_income_p>=child_cred_sp_thresh1 && taxable_income_p<child_cred_sp_thresh2)*child_cred_sp_ch1_1+(taxable_income_p>=child_cred_sp_thresh2 && taxable_income_p<child_cred_sp_thresh3)*child_cred_sp_ch1_2+(taxable_income_p>=child_cred_sp_thresh3 && taxable_income_p<child_cred_sp_thresh4)*child_cred_sp_ch1_3+(taxable_income_p>=child_cred_sp_thresh4 && taxable_income_p<child_cred_sp_thresh5)*child_cred_sp_ch1_4+(taxable_income_p>=child_cred_sp_thresh5 && taxable_income_p<child_cred_sp_thresh6)*child_cred_sp_ch1_5+(taxable_income_p>=child_cred_sp_thresh6 && taxable_income_p<child_cred_sp_thresh7)*child_cred_sp_ch1_6+(taxable_income_p>=child_cred_sp_thresh7)*child_cred_sp_ch1_7);
    elseif children==2
        child_cr_p=((taxable_income_p>=child_cred_sp_thresh1 && taxable_income_p<child_cred_sp_thresh2)*child_cred_sp_ch2_1+(taxable_income_p>=child_cred_sp_thresh2 && taxable_income_p<child_cred_sp_thresh3)*child_cred_sp_ch2_2+(taxable_income_p>=child_cred_sp_thresh3 && taxable_income_p<child_cred_sp_thresh4)*child_cred_sp_ch2_3+(taxable_income_p>=child_cred_sp_thresh4 && taxable_income_p<child_cred_sp_thresh5)*child_cred_sp_ch2_4+(taxable_income_p>=child_cred_sp_thresh5 && taxable_income_p<child_cred_sp_thresh6)*child_cred_sp_ch2_5+(taxable_income_p>=child_cred_sp_thresh6 && taxable_income_p<child_cred_sp_thresh7)*child_cred_sp_ch2_6+(taxable_income_p>=child_cred_sp_thresh7)*child_cred_sp_ch2_7);
    elseif children==3
        child_cr_p=((taxable_income_p>=child_cred_sp_thresh1 && taxable_income_p<child_cred_sp_thresh2)*child_cred_sp_ch3_1+(taxable_income_p>=child_cred_sp_thresh2 && taxable_income_p<child_cred_sp_thresh3)*child_cred_sp_ch3_2+(taxable_income_p>=child_cred_sp_thresh3 && taxable_income_p<child_cred_sp_thresh4)*child_cred_sp_ch3_3+(taxable_income_p>=child_cred_sp_thresh4 && taxable_income_p<child_cred_sp_thresh5)*child_cred_sp_ch3_4+(taxable_income_p>=child_cred_sp_thresh5 && taxable_income_p<child_cred_sp_thresh6)*child_cred_sp_ch3_5+(taxable_income_p>=child_cred_sp_thresh6 && taxable_income_p<child_cred_sp_thresh7)*child_cred_sp_ch3_6+(taxable_income_p>=child_cred_sp_thresh7)*child_cred_sp_ch3_7);
    elseif children==4
        child_cr_p=((taxable_income_p>=child_cred_sp_thresh1 && taxable_income_p<child_cred_sp_thresh2)*child_cred_sp_ch4_1+(taxable_income_p>=child_cred_sp_thresh2 && taxable_income_p<child_cred_sp_thresh3)*child_cred_sp_ch4_2+(taxable_income_p>=child_cred_sp_thresh3 && taxable_income_p<child_cred_sp_thresh4)*child_cred_sp_ch4_3+(taxable_income_p>=child_cred_sp_thresh4 && taxable_income_p<child_cred_sp_thresh5)*child_cred_sp_ch4_4+(taxable_income_p>=child_cred_sp_thresh5 && taxable_income_p<child_cred_sp_thresh6)*child_cred_sp_ch4_5+(taxable_income_p>=child_cred_sp_thresh6 && taxable_income_p<child_cred_sp_thresh7)*child_cred_sp_ch4_6+(taxable_income_p>=child_cred_sp_thresh7)*child_cred_sp_ch4_7);;
    end 
end
