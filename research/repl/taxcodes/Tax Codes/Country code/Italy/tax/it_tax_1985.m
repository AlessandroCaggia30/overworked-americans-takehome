...
%Dependent worker
%principal
if taxable_income_p<=furth_cred_thresh1
    basic_cr_p=furth_cred1;
elseif taxable_income_p>furth_cred_thresh1 && taxable_income_p<=furth_cred_thresh2
    basic_cr_p=(taxable_income_p-furth_cred_thresh1)*((furth_cred2-furth_cred1)/(furth_cred_thresh2-furth_cred_thresh1))+furth_cred1;
else
    basic_cr_p=0;
end
...
%spouse
if taxable_income_s>0 && taxable_income_s<=furth_cred_thresh1
    basic_cr_s=furth_cred1;
elseif taxable_income_s>furth_cred_thresh1 && taxable_income_s<=furth_cred_thresh2
    basic_cr_s=(taxable_income_s-furth_cred_thresh1)*((furth_cred2-furth_cred1)/(furth_cred_thresh2-furth_cred_thresh1))+furth_cred1;
else
    basic_cr_s=0;
end
...
%%%%Total tax credit
tax_cr_p= min(inctax_p_gr, base_cr_p+basic_cr_p+spouse_cr+child_cr_p);
tax_cr_s= min(inctax_s_gr,base_cr_s+basic_cr_s+child_cr_s);
