...
% Social security contributions for principal earner 
 ...
 function [socsec,socsec_emp] = ger_socsec_2013( wage, insurable_ceiling,insurable_ceiling2, pension_rate, sickness_rate, unemployment_rate, care_rate, taxyear, married, children, soc_sec_lim,pension_rate_emp,sickness_rate_emp,unemployment_rate_emp,care_rate_emp,soc_sec_lim2,ssc_factor)
