...
% Social security contributions for principal earner 
 ...
 function [socsec,socsec_emp] = ger_socsec_2006_2008( wage, insurable_ceiling,insurable_ceiling2, pension_rate, sickness_rate, unemployment_rate, care_rate, taxyear, married, children, soc_sec_lim,pension_rate_emp,sickness_rate_emp,unemployment_rate_emp,care_rate_emp,soc_sec_lim2,ssc_factor,ssc_rate_tot)
...
elseif wage <= 9600
	if taxyear ==2006
		socsec = 0.419*(((0.5967*4800)+((2-0.5967)*(wage-4800)))-(wage/2));
	elseif taxyear == 2007
		socsec = 0.391*(((0.7673*4800)+((2-0.7673)*(wage-4800)))-(wage/2));
	elseif taxyear == 2008
		socsec = ssc_rate_tot*(((ssc_factor*soc_sec_lim)+((2-ssc_factor)*(wage-soc_sec_lim)))-(wage/2));
    end
...
if wage <= soc_sec_lim && taxyear==2008
    socsec_emp=wage*0.3;
elseif wage <= soc_sec_lim && (taxyear==2007 || taxyear==2006)
