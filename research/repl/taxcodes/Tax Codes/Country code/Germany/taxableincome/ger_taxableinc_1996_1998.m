...
function [taxable_inc, taxable_inc_child] = ger_taxableinc_1996_1998(wage_principal, wage_spouse, married, children, taxyear, Avg_wage_couple, ss_all, ss_all_red, ssr_lim, socsec_p , socsec_s, socsec_couple, wr_all, lone_par, se_all, child_all, sickness_rate, unemployment_rate, care_rate, pension_rate)
