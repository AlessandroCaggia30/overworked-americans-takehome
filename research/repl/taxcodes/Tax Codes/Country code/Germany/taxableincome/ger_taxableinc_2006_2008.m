...
function [taxable_inc, taxable_inc_child] = ger_taxableinc_2006_2008(wage_principal, wage_spouse, married, children, ...
    taxyear, Avg_wage_couple, ss_all, ss_all_red, ssr_lim, socsec_p , socsec_s, socsec_couple, wr_all, lone_par,...
    se_all, child_all, sickness_rate, unemployment_rate, care_rate,pension_rate, insurable_ceiling, insurable_ceiling2, limit, ssc_p_limit )
...
% Tax allowance Calculation OLD Scheme----------------------------------------------------------------- 
    function [ss_ded, ss_ded_new, ss_ded_old] = socsec_ded(wage, ss_all_red, ss_all, ssr_lim, socsec, limit, ssc_p_limit,insurable_ceiling,insurable_ceiling2)
...
%-------------------------------------------------------------------------------------------------------------        
% the NEW Scheme for tax allowances from 2006
        ...
        others =  min(limit , (min(unemployment_rate*insurable_ceiling, unemployment_rate*wage) + min(sickness_rate*insurable_ceiling2, sickness_rate*wage) +  min(care_rate*insurable_ceiling2, care_rate*wage) ) );
...
ss_ded_p = socsec_ded(wage_principal, ss_all_red, ss_all, ssr_lim, socsec_p, limit, ssc_p_limit,insurable_ceiling,insurable_ceiling2);
ss_ded_s = socsec_ded(wage_spouse,    ss_all_red, ss_all, ssr_lim, socsec_s, limit, ssc_p_limit,insurable_ceiling,insurable_ceiling2);
ss_ded_couple = socsec_ded((wage_principal+wage_spouse), ss_all_red, (2*ss_all), (2*ssr_lim), (socsec_s+socsec_p), 2*limit,  2*ssc_p_limit,2*insurable_ceiling,2*insurable_ceiling2);
