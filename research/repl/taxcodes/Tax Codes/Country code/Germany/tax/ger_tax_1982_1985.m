function [inctax] = ger_tax_1982_1985(taxable_inc,tx1,tx2, tx3, tx4, tx5, tx6, tx7, tx8, tx9, tx10, tx11, tx12, tx13, tx14, tx15, tx16, tx17, tx18, tx19, tx20)
...
% Income tax Function without children
 ...
 taxable_inc = (floor(new))*54;
	...
	elseif  taxable_inc <= tx18
		inctax = ((((tx13*z_principal) + tx14)*z_principal + tx15)*z_principal + tx16)*z_principal + tx17 ;
	else
		inctax =  taxable_inc*tx19 - tx20 ; 
	end 
