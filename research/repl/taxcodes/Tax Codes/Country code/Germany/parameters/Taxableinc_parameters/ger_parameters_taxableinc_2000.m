...
function [ss_all, ss_all_red, ssr_lim, wr_all, lone_par, se_all, child_all, child_credit, child_credit2,child_credit3] = ger_parameters_taxableinc_2000
	...
	lone_par        = 5616   ;       		% lone parent allowance if you are single and have children
	 ...
	 child_credit	= 3240	;			% child credit for each of the first and second children 
	 ...
	 child_all      = 4968	;			% child allowance (1848 child + 1080 education/ for couples its multiplied by two)
