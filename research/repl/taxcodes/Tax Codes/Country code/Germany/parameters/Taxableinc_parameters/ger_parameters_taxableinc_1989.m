...
function [ basic_relief, wr_all,ss_rate, child_all, child_credit, child_credit2,child_credit3, child_credit4, net_inc_ceiling, net_inc_ceiling2, net_inc_ceiling_child, add_child_transfer, child_credit_spec , ssc_limit_sing, ssc_limit_coup] = ger_parameters_taxableinc_1989
     ...
     net_inc_ceiling_child = 9200 ;            % net income ceiling amount extra per child, taken when children cash transfers are computed
        ...
        add_child_transfer     = 552  ;            % additional cash transfers per child for non-taxpayers, taken when children cash transfers are computed
     	...
     	ssc_limit_coup         = 7146  ;           % upper limit for the deductions for social security contributions  for a couple
end