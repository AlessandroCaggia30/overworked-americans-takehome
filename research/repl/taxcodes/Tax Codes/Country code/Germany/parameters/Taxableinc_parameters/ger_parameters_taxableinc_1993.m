...
function [ wr_all,ss_rate, child_all, child_credit, child_credit2,child_credit3, child_credit4, net_inc_ceiling, net_inc_ceiling2, net_inc_ceiling_child, add_child_transfer, child_credit_spec , ssc_limit_sing, ssc_limit_coup] = ger_parameters_taxableinc_1992_1993



	 wr_all		= 2000	;			% Work related allowance 
	 ss_rate	= 0.18	;			% social security contributions are deducible up to specific per cent of the gross wage, and specific ceiling
     ...
     ssc_limit_sing         = 3915  ;           % upper limit for the deductions for social security contributions for a single person
     ssc_limit_coup         = 9200  ;           % upper limit for the deductions for social security contributions  for a couple
end