...
function [ss_all, ss_all_red, ssr_lim, wr_all, lone_par, se_all, child_all, child_credit, child_credit2, limit, ssc_p_limit,child_credit3,lone_add ] = ger_parameters_taxableinc_2015
	 ...
	 child_credit	= 2256	;			% child credit for first & second child
	 child_credit2	= 2328	;			% child credit for third child
     child_credit3  = 2628 ;            % child credit subsequent children
	 child_all      = 3576	;           % child allowance 
