...
function [ wr_all,ss_rate, child_all, child_credit, child_credit2,child_credit3, child_credit4, net_inc_ceiling, net_inc_ceiling2, net_inc_ceiling_child, add_child_transfer, child_credit_spec , ssc_limit_sing, ssc_limit_coup] = ger_parameters_taxableinc_1990
	 ...
	 child_credit2	= 1380	;			% child cash transfers (credit) for the second chil 
	 ...
	 child_all      = 1512	;			% child allowance multiplied by two (2) ( for couples is multiplied by four (4))
     ...
     add_child_transfer     = 575  ;            % additional cash transfers per child for non-taxpayers, taken when children cash transfers are computed
     ssc_limit_sing         = 3510  ;           % upper limit for the deductions for social security contributions for a single person
     ssc_limit_coup         = 7654  ;           % upper limit for the deductions for social security contributions  for a couple
end