%  Taxation in the German system for the year 1998 

function [inctax,socsec_couple, netincome,ssc_empr] = tax_ger_1998(wage_principal, wage_spouse, married, children, taxyear)



%************************** execute the Parameter functions *************************************************************************************************

	[insurable_ceiling, insurable_ceiling2, pension_rate, sickness_rate, unemployment_rate, care_rate, soc_sec_lim]=ger_parameters_socsec_1998;
	[tx1, tx2, tx3, tx4, tx5, tx6, tx7, tx8, tx9, tx10, tx11, tx12, tx13]=ger_parameters_tax_1998;
...
%********************************************** 2)  TAX DEDUCTIONS   *********************************************************************************************
	...
	[taxable_inc, taxable_inc_child] = ger_taxableinc_1996_1998(wage_principal, wage_spouse, married, children, taxyear, Avg_wage_couple, ...
