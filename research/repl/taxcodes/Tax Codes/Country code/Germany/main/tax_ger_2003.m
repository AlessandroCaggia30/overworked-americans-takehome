% Taxation in the German system for the year 2003 


function [inctax,socsec_couple, netincome,ssc_empr] = tax_ger_2003(wage_principal, wage_spouse, married, children, taxyear)


%************************** execute the Parameter functions *************************************************************************************************

	[insurable_ceiling, insurable_ceiling2, pension_rate, sickness_rate, unemployment_rate, care_rate, soc_sec_lim]=ger_parameters_socsec_2003;
	[tx1, tx2, tx3, tx4, tx5, tx6, tx7, tx8, tx9, tx10, tx11, tx12, tx13]=ger_parameters_tax_2002_2003;
	[ss_all, ss_all_red, ssr_lim, wr_all, lone_par, se_all, child_all,child_credit, child_credit2] = ger_parameters_taxableinc_2002_2003;
