% Taxation in Portugal in year 1983

function[inctax,socsec_p,socsec_s,benefit,netincome,socsec_emp]=tax_pt_1983(wage_principal,wage_spouse,married,children)
...
elseif children==3
    benefit=2*child_ben+child_ben3;
elseif children>3
    benefit=2*child_ben+child_ben3+(children-3)*child_ben4;
end
