% Taxation in Portugal in year 1990

function[inctax,socsec_p,socsec_s,benefit,netincome,socsec_emp]=tax_pt_1990(wage_principal,wage_spouse,married,children)
%uses socialsecurity function of 2000 because they
%are the same
%uses taxableincome function of 1993
%************************** EXECUTE THE PARAMETER FUNCTION ************************

[ssc_r,perc,max_all,single_all,married_all,taxbracket1,taxbracket2,taxbracket3,taxbracket4,tax_r1,tax_r2,tax_r3,tax_r4,tax_r5,married_cred,single_cred,child_cred ,child_ben,taxinc_var,ssc_emp_r]=pt_parameters_1990;
