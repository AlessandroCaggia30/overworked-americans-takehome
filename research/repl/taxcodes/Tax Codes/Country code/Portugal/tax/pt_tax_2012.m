...
%Surtax
if married==0
    surtax=surtax_r*max(0,(taxable_income_all-taxbracket7));
else
    surtax=surtax_r*max(0,(2*(taxable_income_all/2-taxbracket7)));
end
