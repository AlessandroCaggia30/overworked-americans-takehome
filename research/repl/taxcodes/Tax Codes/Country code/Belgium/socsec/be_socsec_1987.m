...
function[socsec,ssc_p ,ssc_s , workall_p , workall_s,ssc_empr]=be_socsec_1987(wage_principal,wage_spouse,ssc_r,workall_max,workall_lim1,workall_lim2,workall_r1,workall_r2,workall_r3,ssc_empr_r)
...
%Employer's soc sec
ssc_empr_p=round(max(0,(1.08*wage_principal)*ssc_empr_r)); 
ssc_empr_s=round(max(0,(1.08*wage_spouse)*ssc_empr_r)); 
