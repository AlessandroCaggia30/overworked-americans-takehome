%Taxation in Belgium in year 1986
%uses social security function of 1999
%uses tax function 1988
function[inctax,local_tax,socsec,benefit,netincome,ssc_empr]=tax_be_1986(wage_principal,wage_spouse,married,children)
...
[socsec,ssc_p ,ssc_s , workall_p , workall_s,ssc_empr]=be_socsec_1988(wage_principal,wage_spouse,ssc_r,workall_max,workall_lim1,workall_lim2,workall_r1,workall_r2,workall_r3,ssc_empr_r);
