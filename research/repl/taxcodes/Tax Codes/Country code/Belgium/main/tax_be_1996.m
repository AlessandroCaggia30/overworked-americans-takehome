% Taxation in Belgium in year 1996
%uses social security function of 1996
%uses tax function 1998
function[inctax,local_tax,socsec,benefit,netincome,ssc_empr]=tax_be_1996(wage_principal,wage_spouse,married,children)
...
[socsec,ssc_p ,ssc_s , workall_p , workall_s,ssc_empr] =be_socsec_1996(wage_principal,wage_spouse,ssc_r,workall_max,workall_lim1,workall_lim2,workall_lim3,workall_r1,workall_r2,workall_r3,workall_r4,sscspec_lim1,sscspec_lim2,sscspec_lim3,sscspec_r1,sscspec_r2,ssc_empr_r);	
