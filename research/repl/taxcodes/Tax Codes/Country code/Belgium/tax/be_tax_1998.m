...
cg_tax_exc=max(0,finaltax_beforecr - family_credit - spouse_credit);

%Tax  After Credits
cg_tax=tax_r*(max(0,finaltax_beforecr - family_credit - spouse_credit));

finaltaxpaid=round(cg_tax);

%Local Tax
local_tax=round(local_r *cg_tax_exc);
