% Income Tax Calculation in Belgium for year 2012

function[finaltaxpaid,local_tax,region_tax]=be_tax_2012(wage_principal ,wage_spouse,married,children,ssc_p ,ssc_s ,red_p,red_s,workall_p , workall_s,taxbracket1,taxbracket2,taxbracket3,taxbracket4,tax_r1,tax_r2,tax_r3,tax_r4,tax_r5,quote_r,quote_max,child_cr1,child_cr2,child_cr3,child_cr4,child_cr5,s_parent_cr,single_cr,married_cr,supp_cr,supp_cr_thrsh,local_r,basicr_b,basicr_1,basicr_2,basicr_3,basicr_4, lic_r, lic_max,reg_r, red_r)
...
finaltaxpaid=round(max(0,finaltax_beforecr - family_credit - spouse_credit)-basic_cred_p -basic_cred_s);


%Local Tax
local_tax=round(local_r *max(0,finaltax_beforecr - family_credit - spouse_credit));
