...
if finaltax_inc <= surtax_lim1
    ...
    else if finaltax_inc > surtax_lim2 &&finaltax_inc <= surtax_lim3
            surtax=cg_tax*surtax_r2;
        else if finaltax_inc > surtax_lim3 &&finaltax_inc <= surtax_lim4
               surtax=cg_tax*  (  surtax_r2+  surtax_rtph *(finaltax_inc-surtax_lim3)   )  ; 
            else if finaltax_inc > surtax_lim4 
                    surtax=cg_tax*surtax_r3;
                end
            end
        end
    end
