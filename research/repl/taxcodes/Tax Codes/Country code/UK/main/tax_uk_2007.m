% Taxation in United Kingdom for the year 2007

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,emp_socsec]=tax_uk_2007(wage_principal,wage_spouse,married,children)
...
[basic_all,married_all,socseclimit1,socseclimit2,socsec_r1,socsec_r2,socsec_r3,taxbracket1,taxbracket2,tax_r1,tax_r2,tax_r3,child_ben1,child_ben2,singlebenefit,ssc_r2,st]=uk_parameters_2007;
...
%Tax Credit
if children>0
        ct_credit=545+1845*children;
        wft_credit= (1730+1700+705);  
...
if married==0
    inctax_p=inctax_p-final_credit;
        ...
        inctax_s=inctax_s-max(0,final_credit-inctax_p);
        inctax_p=max(0,inctax_p-final_credit);
    else if married==1 && inctax_p<inctax_s
          inctax_p=inctax_p-max(0,final_credit-inctax_s);
