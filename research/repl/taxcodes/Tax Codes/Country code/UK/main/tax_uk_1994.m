% Taxation in United Kingdom for the year 1994

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,emp_socsec]=tax_uk_1994(wage_principal,wage_spouse,married,children)
...
[basic_all,married_all,socseclimit1,socseclimit2,socsec_r1,socsec_r2,taxbracket1,taxbracket2,tax_r1,tax_r2,tax_r3,child_ben1,child_ben2,singlebenefit,socseclim1_emp,socseclim2_emp,socseclim3_emp,socseclim4_emp,socsec_r1_emp,socsec_r2_emp,socsec_r3_emp,socsec_r4_emp]=uk_parameters_1994;
...
if married==1
        inctax_s=round(max(0,inctax_s- max(0,married_all*0.2-inctax_p)));
        inctax_p=round(max(0,inctax_p-married_all*0.2));
end    
