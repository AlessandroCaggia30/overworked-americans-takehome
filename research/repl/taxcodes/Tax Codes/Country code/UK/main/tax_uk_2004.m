% Taxation in United Kingdom for the year 2004

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,emp_socsec]=tax_uk_2004(wage_principal,wage_spouse,married,children)
...
[basic_all,married_all,socseclimit1,socseclimit2,socsec_r1,socsec_r2,socsec_r3,taxbracket1,taxbracket2,tax_r1,tax_r2,tax_r3,child_ben1,child_ben2,singlebenefit,ssc_r2,st]=uk_parameters_2004;
...
%Tax Credit
if children>0
        ct_credit=545+1625*children;
        wft_credit= (1570+1545+640);  
    credit_discount=0.37*max(0,wage_principal+wage_spouse-5060);
