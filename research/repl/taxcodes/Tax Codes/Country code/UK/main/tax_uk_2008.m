%  Taxation in United Kingdom for the year 2008

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,emp_socsec]=tax_uk_2008(wage_principal,wage_spouse,married,children)

%************************** EXECUTE THE PARAMETER FUNCTION ************************

[basic_all,married_all,socseclimit1,socseclimit2,socsec_r1,socsec_r2,socsec_r3,taxbracket1,taxbracket2,tax_r1,tax_r2,tax_r3,child_ben1,child_ben2,singlebenefit,ssc_r2,st]=uk_parameters_2008;
...
%Tax Credit
if children>0
        ct_credit=545+2085*children;
        wft_credit= (1800+1770+735);  
    credit_discount=0.39*max(0,wage_principal+wage_spouse-6420);
        final_credit=max(0,max(545,ct_credit+ wft_credit-credit_discount)- 0.0667*max(0,wage_principal+wage_spouse-50000));
else
    wft_credit= (1800+1770*(married==1)+735);  
    credit_discount=0.39*max(0,wage_principal+wage_spouse-6420);
