%  Taxation in United Kingdom for the year 2009

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,emp_socsec]=tax_uk_2009(wage_principal,wage_spouse,married,children)
...
[basic_all,married_all,socseclimit1,socseclimit2,socsec_r1,socsec_r2,socsec_r3,taxbracket1,taxbracket2,tax_r1,tax_r2,tax_r3,child_ben1,child_ben2,singlebenefit,ssc_r2,st,wtc_basic,wtc_couplelone,wtc_30hr,ctc_family,ctc_child,ntc_1st_thres,ntc_1st_taper,ntc_2nd_thres,ntc_2nd_taper]=uk_parameters_2009;
...
if children>0
    ...
    final_credit=max(0,max(ctc_family,ct_credit+ wft_credit-credit_discount)- ntc_2nd_taper*max(0,wage_principal+wage_spouse-ntc_2nd_thres));
else
