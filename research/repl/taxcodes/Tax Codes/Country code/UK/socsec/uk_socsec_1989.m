...
function[socsec,emp_socsec]=uk_socsec_1989(wage,socseclimit1,socseclimit2,socseclimit3,socseclimit4,socsec_r1,socsec_r2,socsec_r3,socseclim1_emp,socseclim2_emp,socseclim3_emp,socseclim4_emp,socsec_r1_emp,socsec_r2_emp,socsec_r3_emp,socsec_r4_emp)
...
% Change in social security contributions in october 1989.
if weeklywage < socseclimit1
    weeklysocsec2=0;
else
    weeklysocsec2= (0.02*socseclimit1) + socsec_r3*(min(weeklywage,socseclimit4)-socseclimit1);
end

socsec=round(weeklysocsec*39 + weeklysocsec2*13);   %make it yearly
