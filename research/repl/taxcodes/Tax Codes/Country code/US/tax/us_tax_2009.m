...
%MWP
mwp=min((1+married)*mwp_max, (mwp_r*wage))-mwp_taper*max(0,(wage-mwp_thresh));
...
federal_tax=round(inctax-eic_cr-mwp-unemp-child_cred-child_ref);
