...
function [taxable_income,taxable_income_s,employer_health, employer_health_s] = ne_taxableinc_2008(wage_principal,wage_spouse,unemp_r,ssc_ceil,unemp_fran,med_empr,health_ceil)



unemployment = max(0,(min(wage_principal,ssc_ceil)-unemp_fran))*unemp_r; 

employer_health=med_empr*min((wage_principal-unemployment),health_ceil); 
...
% Employers health contribution increases taxable income
 ...
 employer_health_s=med_empr*min((wage_spouse-unemployment_s),health_ceil); 
