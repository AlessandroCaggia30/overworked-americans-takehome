%  Taxation in the Netherlands for the year 1998 

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,empr_socsec]=tax_ne_1998(wage_principal,wage_spouse,married,children)
...
%********************************** 1)  TAXABLE INCOME CALCULATION   *********************************************************************************************
 ...
 [taxableinc_p,compall_p,taxableinc_s,compall_s,employer_health,employer_health_s]=ne_taxableinc_1998(wage_principal,wage_spouse,married,children,basic_all,work_rate,work_min,work_max,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,ssc_ceil,med_limit,med_empr,health_ceil,single_par_all,single_par_rate,transfer_all,comp_rate,comp_max);

% ********************************  2) SOCIAL SECURITY CONTRIBUTIONS *****************	
   
[socsec_p,empr_socsec_p] =ne_socsec_1998(wage_principal,wage_spouse,compall_p,married,taxableinc_p,unemp_r,ssc_ceil,unemp_fran,med_limit,health_ceil,health_r,health_fixed,oldpen_r,widpen_r,ex_med_r,taxbracket2,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,inv_empr_r,employer_health);
[socsec_s,empr_socsec_s] =ne_socsec_1998(wage_spouse,wage_principal,compall_s,married,taxableinc_s,unemp_r,ssc_ceil,unemp_fran,med_limit,health_ceil,health_r,health_fixed,oldpen_r,widpen_r,ex_med_r,taxbracket2,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,inv_empr_r,employer_health_s);
