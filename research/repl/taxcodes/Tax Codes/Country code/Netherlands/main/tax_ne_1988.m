% Taxation in the Netherlands for the year 1988

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,empr_ssc]=tax_ne_1988(wage_principal,wage_spouse,married,children)
...
%********************************** 1)  TAXABLE INCOME CALCULATION   *********************************************************************************************
    ...
    [taxableinc_p,taxableinc_s]=ne_taxableinc_1988(wage_principal,wage_spouse,married,children,basic_all,supp_oneperson,supp_soleearner,single_par_all,single_par_all_two,work_supplement,extrawork_supplement,work_min,unemp_r,inv_r,inv_fran,sick_r,ssc_ceil,med_limit,med_empr,health_ceil,oldpen_r,widpen_r,gen_ceil,transfer_all);

% ********************************  2) SOCIAL SECURITY CONTRIBUTIONS *****************	
   
[socsec_p, empr_ssc_p] =ne_socsec_1988(wage_principal,sick_r,ssc_ceil,unemp_r,inv_r,inv_fran,med_limit,health_ceil,health_r,med_empr,oldpen_r,widpen_r,gen_ceil,work_min,unemp_empr_r1,sick_empr_r,exepmed_r_empr,dis_r_empr,fam_r_empr);
[socsec_s,empr_ssc_s] =ne_socsec_1988(wage_spouse,sick_r,ssc_ceil,unemp_r,inv_r,inv_fran,med_limit,health_ceil,health_r,med_empr,oldpen_r,widpen_r,gen_ceil,work_min,unemp_empr_r1,sick_empr_r,exepmed_r_empr,dis_r_empr,fam_r_empr);
