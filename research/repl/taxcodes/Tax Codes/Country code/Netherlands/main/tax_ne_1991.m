% Taxation in the Netherlands for the year 1991

function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,empr_ssc]=tax_ne_1991(wage_principal,wage_spouse,married,children)
...
[socsec_p, empr_ssc_p] =ne_socsec_1991(wage_principal,wage_spouse,children,comp_allow_p,married,taxableinc_p,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,sick_empr_r,employer_health);
[socsec_s, empr_ssc_s] =ne_socsec_1991(wage_spouse,wage_principal,children,comp_allow_s,married,taxableinc_s,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,sick_empr_r,employer_health_s);
