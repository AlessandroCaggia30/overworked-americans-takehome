...
function[inctax_p,inctax_s,socsec_p,socsec_s,benefit,netincome,empr_socsec]=tax_ne_1997(wage_principal,wage_spouse,married,children)
...
[taxableinc_p,taxableinc_s,comp_allow_p,comp_allow_s,employer_health,employer_health_s]=ne_taxableinc_1997(wage_principal,wage_spouse,married,children,basic_all,work_rate,work_min,work_max,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,ssc_ceil,med_limit,med_empr,health_ceil,single_par_all,single_par_rate,transfer_all,comp_rate,comp_max);

% ********************************  2) SOCIAL SECURITY CONTRIBUTIONS *****************	
   
[socsec_p,empr_socsec_p] =ne_socsec_1997(wage_principal,wage_spouse,children,comp_allow_p,married,taxableinc_p,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,sick_empr_r,min_wage,tax_red_emp,employer_health);
[socsec_s,empr_socsec_s] =ne_socsec_1997(wage_spouse,wage_principal,children,comp_allow_s,married,taxableinc_s,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,sick_empr_r,min_wage,tax_red_emp,employer_health_s);
