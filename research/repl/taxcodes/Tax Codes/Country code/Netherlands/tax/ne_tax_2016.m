...
if taxable_income>emp_cr_thr3 
    work_credit=max(0,work_credit-(min(work_cred3*(taxable_income-emp_cr_thr3))));
end

if taxable_income_s>emp_cr_thr3 
    work_credit_s=max(0,work_credit_s-(min(work_cred3*(taxable_income_s-emp_cr_thr3))));
end
