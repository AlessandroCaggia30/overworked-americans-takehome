...
% Employee social security contributions 
 ...
 function [finalsocsec,empr_socsec,socsec_taxinc,socsec_earn] = ne_socsec_2008(wage_principal,wage_spouse,tax_cr_total,married,taxable_income,taxable_income_s,unemp_r,ssc_ceil,unemp_fran,health_fixed,oldpen_r,widpen_r,ex_med_r,taxbracket2,rate_ssc,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,inv_empr_r,employer_health,employer_health_s)
  ...
  health_ins_s=health_fixed;
    ...
    socsec_earn=unemployment+health_ins; %Socsec based on gross earnings
     socsec_earn_s=unemployment_s+health_ins_s; %note: unemployment_s depends on wage, health_ins_s is paid even if spousal income is zero (in this case paid by principal actually)
