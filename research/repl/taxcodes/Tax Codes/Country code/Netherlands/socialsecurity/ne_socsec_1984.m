...
% Social security contributions for principal earner 
 ...
 function [socsec,empr_ssc] = ne_socsec_1984(wage,sick_r,ssc_ceil,unemp_r,inv_r,inv_fran,med_limit,health_ceil,health_r,med_empr,oldpen_r,widpen_r,gen_ceil,work_rate,work_min,work_max,unemp_empr_r1,sick_empr_r,exepmed_r_empr,dis_r_empr,fam_r_empr, inval_r_empr)
