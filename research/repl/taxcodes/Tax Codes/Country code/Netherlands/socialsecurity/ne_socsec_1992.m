...
% Social security contributions for principal earner 
 ...
 function [socsec,empr_ssc] = ne_socsec_1992(wage,wage_partner,children,comp_allow,married,taxableinc,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,sick_empr_r,employer_health)
