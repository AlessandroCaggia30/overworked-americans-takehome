...
% Employee social security contributions 
 ...
 function [socsec,empr_ssc] = ne_socsec_1997(wage,wage_partner,children,comp_allow,married,taxableinc,unemp_r,unemp_fran,inv_r,inv_fran,sick_r,health_fixed,med_child,health_ceil,health_r,oldpen_r,widpen_r,ex_med_r,ex_med_fixed,ex_med_child,disab_r,ssc_ceil,taxbracket2,work_rate,work_min,work_max,med_empr,comp_rate,med_limit,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,sick_empr_r,min_wage,tax_red_emp,employer_health)
...
if wage<min_wage
    reduc_empr=wage/min_wage*tax_red_emp;
elseif wage>min_wage && wage<1.15*min_wage
    reduc_empr=tax_red_emp;    
else
    reduc_empr=0;    
end

empr_ssc=round(unemp_empr+sick_empr+employer_health-reduc_empr);
