...
function[unemp_r,ssc_ceil,unemp_fran,med_empr,health_ceil,oldpen_r,widpen_r,ex_med_r,taxbracket1,taxbracket2,taxbracket3,tax_r1,tax_r2,tax_r3,tax_r4,comb_credit_fr,singlepar_cr,addsinglepcr_r,gen_cred,emp_cred,work_cred1,work_cred2,emp_cr_thr,work_max,ch_cr_thr,adch_thr,ch_cr,ch_cr2,decrease_r,rate_cr,rate_ssc,ch1_trans,unemp_empr_r1,unemp_empr_r2,unemp_empr_fran1,inv_empr_r,work_cred3,emp_cr_thr3,emp_cr_thr4,work_max_red,incdep_combcred1,incdep_combcred_max,incdep_combcred_per,addsinglepcr_max,work_red_max] = ne_parameters_2012

%Employee Social Security Parameters
unemp_r=0.00;    %unemployment contribution rate for gross earnings between 
ssc_ceil=50064;   %Social Security Ceiling
unemp_fran=17229;   %Unemployment contribution lower bound for wage

med_empr=0.071;
health_ceil=50064;   %Medical insurance net wage ceiling  (med_ceil)    
...
unemp_empr_r1=0.0455;
unemp_empr_r2=0.0277;
unemp_empr_fran1=17229;
inv_empr_r=0.0560;
